...
const ComboCard = ({ name, imageUrl, weightVariants, title=[] }) => {
  ...
  return (
      <div ref={cardRef} className="relative flex flex-col border border-[#D9D9D9] lg:w-[270px] lg:h-[540px] md:w-[215px] md:h-[420px] w-[150px] h-[300px] justify-between item-center">
  ...
  <div className={`absolute top-0 left-0 text-white px-2 py-1 text-center text-[12px] md:text-[14px] lg:text-[16px]  w-[100px] md:w-[110px] lg:w-[130px] rounded-br font-semibold capitalize z-10 ${titleColors[title[0]] || 'bg-[#B7275E]'}`}>
    {title[0]}
        ...
        <div className="flex justify-center items-center mb-2 bg-[#F3EEEA] rounded-b-[20px] lg:w-[268.75px] md:w-[213.75px] lg:h-[233px] w-[148.5px] h-[180px]">
            ...
            <img
              src={imageUrl}
              className="max-w-full lg:h-[160px] md:h-[130px] h-[80px] lg:hover:scale-125 transition-all duration-500 cursor-pointer"
              alt={name}
            />
        ...
        <div>
          ...
          {discountedPrice > 0 && discountedPrice < price ? (
            <>
              ...
              {discountPercent > 0 && (
                <div className="text-[12px] md:text-[16px] lg:text-[18px] text-[#3149A6] font-[500] text-center">
                  {discountPercent}% off
                </div>
              )}
            </>
            ...
            {quantites[selectedId] > 0 ? (
              <div className="flex items-center mt-2 mb-3 mx-2.5 md:mx-4 lg:mx-[23px]">
                ...
                <input
                  ...
                  className="w-[80px] md:h-7 md:w-[116px] md:text-[16px] lg:w-[140px] h-6 lg:h-10 text-[14px] lg:text-[18px] rounded-[0px] text-center border-y-2 border-[#0C5273] text-white bg-[#0C5273] font-[500]"
                />
                <button
